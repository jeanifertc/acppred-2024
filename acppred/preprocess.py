...
def compute_aa_composition(peptide) -> dict:
    """
    Computes the aminoacid composition for a peptide sequence and returns a dictionary 
    containing the percentage of each aminoacid
...
def preprocess_datasets(positive_peptide_file:str, negative_peptide_file:str, output_file:str='data/processed/train.csv') -> None:
    ...
    - netiveve_peptide_file (str): file containing peptides that have no anticancer activity
